<div class="main-bg" style="background-image:url(<?php echo get_template_directory_uri(); ?>/img/bg/main.jpg);">
    ...
    <img class="logo" src="<?php echo get_template_directory_uri(); ?>/img/logo/lvivin.png" alt="Логотип">
      <p>Наша контактна інформація:<br> +380679047415 (мобільний тел.)<br>

Щоб зарезервувати екскурсію/ тур, надішліть листа на contact@lvivin.info, вказуючи:<br>
- своє ім'я та прізвище,<br> 
- мобільний телефон, <br>
- назву туру, який Ви хочете забронювати, <br>
- точні дати, <br>
- кількість осіб.<br>
Ми також пропонуємо зустріч в аеропорту, на автобусному / залізничному вокзалі.</p>
    </div>
    ...
    <div class="modal-content">
    <img class="logo" src="<?php echo get_template_directory_uri(); ?>/img/logo/lvivin.png" alt="Логотип">
      <p>Щоб зарезервувати готель,апартамент чи хостел, надішліть листа на contact@lvivin.com, вказуючи:<br>
- своє ім'я та прізвище, <br>
- контактний телефон, <br>
- апартамент, який Ви хочете забронювати, <br>
- точні дати,<br>
- кількість осіб.<br>

Поселення до апартаментів здійснюється з 13.00, виселення - до 12.00. <br>
В апартаментах є всі умови, що й у готелі (постіль, рушники), гаряча та холодна вода - цілодобово, і вони розташовані в центрі міста. <br>
Вам потрібно буде внести передоплату в розмірі вартості однієї ночі проживання. Передоплата повертається в повному обсязі, якщо Ви скасовуєте бронювання не пізніше ніж за 14 днів до дня поселення в апартаменти.<br>
У святкові дні ціни на апартаменти можуть відрізнятися від поданих на сайті.<br>
Для гарантії бронювання потрібно внести передоплату. Передоплата повертається в повному обсязі, якщо Ви скасовуєте бронювання не пізніше ніж за 7 днів до дня поселення в хостелі. <br>
Також ми пропонуємо зустріч в аеропорту, на автобусному / залізничному вокзалі.<br>

Наша контактна інформація:<br> +380679047415 (мобільний тел.)</p>
    </div>
    <div class="modal-footer">
      <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat">Закрити</a>
    </div>
    ...
    <div class="modal-content">
    <img class="logo" src="<?php echo get_template_directory_uri(); ?>/img/logo/lvivin.png" alt="Логотип">
      <p>У нашій агенції Ви можете придбати екскурсійні автобусні або авіа тури Європою а також, пішохідні та автобусні екскурсії Львовом.
Ми пропонуємо зокрема автобусні тури без нічних переїздів кращими містами Європи.
Екскурсійні тури представлені на нашому сайті поділені по категоріям, 
а тому Вам буде легко обрати для себе потрібний тур. 
Ми з радістю задовільним усі Ваші бажання та підберемо для Вас тур, який повністю відповідатиме вашим критеріям.</p>
    </div>
    <div class="modal-footer">
      <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat">Закрити</a>
    </div>
